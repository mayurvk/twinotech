<html>
    ...
    <body> 
        ...
        <br><br>
        <a href="login_details.php" target="main"><input type="button" id="b1" name="LoginDetails" value="LoginDetails"></a>
        <br><br>
        <a href="edit.php" target="main"><input type="button" id="b1" name="Edit" value="Edit"></a>
        <br><br>
        <a href="login.html" target="_top"><input type="button" id="b1" name="logout" value="LogOut"></a>
	</body>
</html>